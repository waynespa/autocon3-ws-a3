...
if command -v docker >/dev/null 2>&1; then
    docker completion zsh > "/home/vscode/.oh-my-zsh/custom/plugins/zsh-autocomplete/Completions/_docker"
else
    echo "Docker not found, skipping Docker zsh completion setup"
fi